...
document.getElementById('displayTodos').addEventListener('click', async () => {
    ...
    // TODO ✅ Display the todos within in element id of 'todoDisplay'
    document.getElementById('todoDisplay').textContent = JSON.stringify(todos, null, 2);
  });
  

  // There a bunch of missing keywords in the following code, fix them to have the code work correctly!
